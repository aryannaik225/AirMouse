  ...
  return (
    <section className="relative py-32 px-6 sm:px-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 h-full w-full bg-white 
        bg-[repeating-linear-gradient(135deg,#e5e5e5_0px,#e5e5e5_1px,transparent_2px,transparent_12px)]">
        ...
        {/* Glow element */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[500px] h-[500px] bg-white/40 rounded-full blur-[120px] opacity-30" />
      </div>
